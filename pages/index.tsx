          ...
          <div className='w-full h-[100vh] '>
            <div className='w-full md:w-[60%] h-full text-white font-medium flex justify-center items-center'>
              <div>
                ...
                <div className='text-lg md:text-36 pb-8 text-center md:text-left'>🖥️ Full Stack Web Development</div>
                <div className='text-lg md:text-36 pb-8 text-center md:text-left'>🔍 Web Scraping & Data Extraction</div>
                <div className='text-lg md:text-36 pb-8 text-center md:text-left'>🤖 Python Automation & Custom Bots</div>
                <div className='text-lg md:text-36 pb-8 text-center md:text-left'>🧠 AI & Machine Learning Engineering</div>
                <div className='text-lg md:text-36 pb-8 text-center md:text-left'>with 5 Years of Experience</div>
