...
const sendEmail = () => {    
  window.open("mailto:britness.gmd@gmail.com?subject=Contact");
};
              ...
              <div className='text-white text-base md:text-lg font-normal'>
                  ...
                  <div className='text-lg md:text-36 font-medium'>
                    <Link href={'#'}>
                      <a className='hover:text-amber-500' onClick={()=>sendEmail()}>
                        <div className=''>valeriisemash@gmail.com</div>                
                      </a>
                    </Link>
                </div>
                </div>
                {/* <div className='mt-20'>
                  ...
                  <div className='text-white text-xl md:text-45 font-medium mt-2 flex justify-between items-center'>
                    <Link href={'https://join.skype.com/GW0knjPGWeQY'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaSkype/>
                      </a>
                    </Link>
                    <Link href={'https://github.com/DreamHigh0820'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaGithub/>
                      </a>
                    </Link>
                    <Link href={'https://discord.gg/dreamhigh0820#0965'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaDiscord/>
                      </a>
                    </Link>
                    <Link href={'https://t.me/DanielLee0820'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaTelegram/>
                      </a>
                    </Link>
